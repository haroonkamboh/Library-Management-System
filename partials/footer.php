    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-4">
                <a href="#"><h1 class="logo-lm">Library Management</h1></a>
            ...
            <div class="col-xs-12 col-sm-4 col-md-3 col-md-offset-1">
                ...
                <table class="table border-none addr-dt">
                    <tr>
                        ...
                        <td><address>Fast University KHI</address></td>
                    </tr>
                    <tr>
                        <td><i class="icofont icofont-email"></i></td>
                        <td>librarymanagement@gmail.com</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><a href="" target="_blank">Hroon Developers</a></td>
                    </tr>
                </table>
            </div>
            <div class="col-xs-12 col-sm-4 col-md-3 col-md-offset-1">
